...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "ClientsMine" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:creator", content: "@KrrishSR4" },
      { title: "ClientsMine | Discover Businesses Missing Their Digital Prese" },
      { property: "og:title", content: "ClientsMine | Discover Businesses Missing Their Digital Prese" },
      { name: "twitter:title", content: "ClientsMine | Discover Businesses Missing Their Digital Prese" },
